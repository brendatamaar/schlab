      ...
      <div class="p-4">
        ...
        <div class="app-calendar-events-filter">
          <div class="form-check form-check-danger mb-3">
            ...
            <label class="form-check-label" for="select-personal">Exam</label>
          </div>
          <div class="form-check mb-3">
            <input class="form-check-input input-filter" type="checkbox" id="select-business" data-value="business" checked>
            <label class="form-check-label" for="select-business">Class</label>
          </div>
          <div class="form-check form-check-warning mb-3">
            <input class="form-check-input input-filter" type="checkbox" id="select-family" data-value="family" checked>
            <label class="form-check-label" for="select-family">Extracurricular activity</label>
          </div>
          <div class="form-check form-check-success mb-3">
            <input class="form-check-input input-filter" type="checkbox" id="select-holiday" data-value="holiday" checked>
            <label class="form-check-label" for="select-holiday">School event</label>
          </div>
          <div class="form-check form-check-info">
            <input class="form-check-input input-filter" type="checkbox" id="select-etc" data-value="etc" checked>
            <label class="form-check-label" for="select-etc">Other</label>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="offcanvas-body">
          <form class="event-form pt-0" id="eventForm" onsubmit="return false">
            ...
            <div class="form-floating form-floating-outline mb-4 select2-primary">
              ...
              <label for="eventGuests">Add Person</label>
            </div>
            <div class="form-floating form-floating-outline mb-4">
